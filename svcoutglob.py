...
def out_space_events_parser(file,cmd):
   ...
   for ln in file:
      if ln.startswith(cmd):
         ...
         elif (data[105:113]=="event_id"):
            print(data[105:113])
            marker_set = [[0,15],[16,30],[31,42],[43,52],[53,64],[83,90],[91,98],[99,104],[105,113],[114,124],[125,190]]
         elif (data[96:104]=="event_id"):
            print(data[96:104])
            marker_set = [[0,15],[16,30],[31,43],[44,53],[54,70],[71,78],[79,89],[90,95],[96,104],[105,115],[116,190]]
         elif (data[104:112]=="event_id"):
            print(data[104:112])
            marker_set = [[0,15],[16,30],[31,46],[47,63],[64,81],[82,89],[90,97],[98,103],[104,112],[113,123],[124,190]]
         else:
            print("lsevent all_versions")
            marker_set = [[0,14],[16,27],[31,45],[47,62],[64,77],[78,84],[85,92],[93,98],[99,107],[108,118],[119,190]]
         data = next(file)
         block = []
         while data != '\n':
            values = {}
